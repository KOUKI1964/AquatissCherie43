...
import { Heart, ShoppingBag, Tag, Key, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-100 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center mb-8">
          <Sparkles className="h-6 w-6 text-[#8B1F38] mr-2" />
          <h1 className="text-3xl font-serif font-bold text-gray-900">Nouveautés</h1>
        </div>

        <div className="bg-white p-6 rounded-lg shadow-sm mb-8">
          <p className="text-gray-600">
            Découvrez nos dernières créations et tendances. Notre collection de nouveautés est régulièrement mise à jour pour vous offrir le meilleur de la mode.
          </p>
        </div>
