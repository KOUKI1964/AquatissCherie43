/*
  # Setup Product Media Associations

  1. Changes
    - Create product_media table for managing media associations
    - Add constraints and indexes
    - Setup RLS policies
    - Add triggers for managing primary images
...
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    ...
    FROM (
      SELECT media_id, ROW_NUMBER() OVER (
