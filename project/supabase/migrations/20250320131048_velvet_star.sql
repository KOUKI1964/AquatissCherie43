/*
  # Ajout de l'identifiant utilisateur unique

  1. Modifications
    - Ajout de la colonne `user_identifier` (text, unique) à la table profiles
    - Création d'une fonction pour générer un identifiant unique
    - Création d'un trigger pour générer automatiquement l'identifiant
